...
g[l].split(""),h=0;3>h;h++)if("0"===e[0]&&1<e.length)e.splice(0,1);else break;g[l]=e.join("")}var e=-1,n=h=0,r=-1,z=!1;for(l=0;l<b;l++)z?"0"===g[l]?n+=1:(z=!1,n>h&&(e=r,h=n)):"0"===g[l]&&(z=!0,r=l,n=1);n>h&&(e=r,h=n);1<h&&g.splice(e,h,"");e=g.length;b="";""===g[0]&&(b=":");for(l=0;l<e;l++){b+=g[l];if(l===e-1)break;b+=":"}""===g[e-1]&&(b+=":");return b},noConflict:function(){e.IPv6===this&&(e.IPv6=h);return this}}});
(function(e){function h(b){throw RangeError(B[b]);}function g(b,f){for(var e=b.length;e--;)b[e]=f(b[e]);return b}function u(b,e){return g(b.split(f),e).join(".")}function b(b){for(var f=[],e=0,k=b.length,a,c;e<k;)a=b.charCodeAt(e++),55296<=a&&56319>=a&&e<k?(c=b.charCodeAt(e++),56320==(c&64512)?f.push(((a&1023)<<10)+(c&1023)+65536):(f.push(a),e--)):f.push(a);return f}function l(b){return g(b,function(b){var f="";65535<b&&(b-=65536,f+=C(b>>>10&1023|55296),b=56320|b&1023);return f+=C(b)}).join("")}function y(b,
f){return b+22+75*(26>b)-((0!=f)<<5)}function n(b,f,e){var k=0;b=e?v(b/700):b>>1;for(b+=v(b/f);455<b;k+=36)b=v(b/35);return v(k+36*b/(b+38))}function r(b){var f=[],e=b.length,k,a=0,c=128,d=72,m,A,x,g,r;m=b.lastIndexOf("-");0>m&&(m=0);for(A=0;A<m;++A)128<=b.charCodeAt(A)&&h("not-basic"),f.push(b.charCodeAt(A));for(m=0<m?m+1:0;m<e;){A=a;k=1;for(x=36;;x+=36){m>=e&&h("invalid-input");g=b.charCodeAt(m++);g=10>g-48?g-22:26>g-65?g-65:26>g-97?g-97:36;(36<=g||g>v((2147483647-a)/k))&&h("overflow");a+=g*k;r=
x<=d?1:x>=d+26?26:x-d;if(g<r)break;g=36-r;k>v(2147483647/g)&&h("overflow");k*=g}k=f.length+1;d=n(a-A,k,0==A);v(a/k)>2147483647-c&&h("overflow");c+=v(a/k);a%=k;f.splice(a++,0,c)}return l(f)}function z(f){var e,k,g,a,c,d,m,A,x,r=[],q,t,z;f=b(f);q=f.length;e=128;k=0;c=72;for(d=0;d<q;++d)x=f[d],128>x&&r.push(C(x));for((g=a=r.length)&&r.push("-");g<q;){m=2147483647;for(d=0;d<q;++d)x=f[d],x>=e&&x<m&&(m=x);t=g+1;m-e>v((2147483647-k)/t)&&h("overflow");k+=(m-e)*t;e=m;for(d=0;d<q;++d)if(x=f[d],x<e&&2147483647<
++k&&h("overflow"),x==e){A=k;for(m=36;;m+=36){x=m<=c?1:m>=c+26?26:m-c;if(A<x)break;z=A-x;A=36-x;r.push(C(y(x+z%A,0)));A=v(z/A)}r.push(C(y(A,0)));c=n(k,t,g==a);k=0;++g}++k;++e}return r.join("")}var D="object"==typeof exports&&exports,k="object"==typeof module&&module&&module.exports==D&&module,q="object"==typeof global&&global;if(q.global===q||q.window===q)e=q;var t,w=/^xn--/,p=/[^ -~]/,f=/\x2E|\u3002|\uFF0E|\uFF61/g,B={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)",
"invalid-input":"Invalid input"},v=Math.floor,C=String.fromCharCode,E;t={version:"1.2.3",ucs2:{decode:b,encode:l},decode:r,encode:z,toASCII:function(b){return u(b,function(b){return p.test(b)?"xn--"+z(b):b})},toUnicode:function(b){return u(b,function(b){return w.test(b)?r(b.slice(4).toLowerCase()):b})}};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return t});else if(D&&!D.nodeType)if(k)k.exports=t;else for(E in t)t.hasOwnProperty(E)&&(D[E]=t[E]);else e.punycode=
t})(this);
...
d[0]?b.decode(d.join(":")):null,a=a.substring(m+1)):(c.username=null,c.password=null);return a};b.parseQuery=function(a,c){if(!a)return{};a=a.replace(/&+/g,"&").replace(/^\?*&*|&+$/g,"");if(!a)return{};for(var d={},m=a.split("&"),e=m.length,f,k,g=0;g<e;g++)f=m[g].split("="),k=b.decodeQuery(f.shift(),c),f=f.length?b.decodeQuery(f.join("="),c):null,B.call(d,k)?("string"===typeof d[k]&&(d[k]=[d[k]]),d[k].push(f)):d[k]=f;return d};b.build=function(a){var c="";a.protocol&&(c+=a.protocol+":");a.urn||!c&&
...
b.buildUserinfo=function(a){var c="";a.username&&(c+=b.encode(a.username),a.password&&(c+=":"+b.encode(a.password)),c+="@");return c};b.buildQuery=function(a,c,d){var m="",e,f,k,g;for(f in a)if(B.call(a,f)&&f)if(n(a[f]))for(e={},k=0,g=a[f].length;k<g;k++)void 0!==a[f][k]&&void 0===e[a[f][k]+""]&&(m+="&"+b.buildQueryParameter(f,a[f][k],d),!0!==c&&(e[a[f][k]+""]=!0));else void 0!==a[f]&&(m+="&"+b.buildQueryParameter(f,a[f],d));return m.substring(1)};b.buildQueryParameter=function(a,c,d){return b.encodeQuery(a,
d)+(null!==c?"="+b.encodeQuery(c,d):"")};b.addQuery=function(a,c,d){if("object"===typeof c)for(var m in c)B.call(c,m)&&b.addQuery(a,m,c[m]);else if("string"===typeof c)void 0===a[c]?a[c]=d:("string"===typeof a[c]&&(a[c]=[a[c]]),n(d)||(d=[d]),a[c]=(a[c]||[]).concat(d));else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");};b.removeQuery=function(a,c,d){var m;if(n(c))for(d=0,m=c.length;d<m;d++)a[c[d]]=void 0;else if("RegExp"===y(c))for(m in a)c.test(m)&&(a[m]=void 0);
else if("object"===typeof c)for(m in c)B.call(c,m)&&b.removeQuery(a,m,c[m]);else if("string"===typeof c)void 0!==d?"RegExp"===y(d)?!n(a[c])&&d.test(a[c])?a[c]=void 0:a[c]=r(a[c],d):a[c]===d?a[c]=void 0:n(a[c])&&(a[c]=r(a[c],d)):a[c]=void 0;else throw new TypeError("URI.removeQuery() accepts an object, string, RegExp as the first parameter");};b.hasQuery=function(a,c,d,m){if("object"===typeof c){for(var e in c)if(B.call(c,e)&&!b.hasQuery(a,e,c[e]))return!1;return!0}if("string"!==typeof c)throw new TypeError("URI.hasQuery() accepts an object, string as the name parameter");
switch(y(d)){case "Undefined":return c in a;case "Boolean":return a=Boolean(n(a[c])?a[c].length:a[c]),d===a;case "Function":return!!d(a[c],c,a);case "Array":return n(a[c])?(m?z:D)(a[c],d):!1;case "RegExp":return n(a[c])?m?z(a[c],d):!1:Boolean(a[c]&&a[c].match(d));case "Number":d=String(d);case "String":return n(a[c])?m?z(a[c],d):!1:a[c]===d;default:throw new TypeError("URI.hasQuery() accepts undefined, boolean, string, number, RegExp, Function as the value parameter");}};b.commonPath=function(a,c){var d=
Math.min(a.length,c.length),b;for(b=0;b<d;b++)if(a.charAt(b)!==c.charAt(b)){b--;break}if(1>b)return a.charAt(0)===c.charAt(0)&&"/"===a.charAt(0)?"/":"";if("/"!==a.charAt(b)||"/"!==c.charAt(b))b=a.substring(0,b).lastIndexOf("/");return a.substring(0,b+1)};b.withinString=function(a,c,d){d||(d={});var e=d.start||b.findUri.start,f=d.end||b.findUri.end,k=d.trim||b.findUri.trim,g=/[a-z0-9-]=["']?$/i;for(e.lastIndex=0;;){var r=e.exec(a);if(!r)break;r=r.index;if(d.ignoreHtml){var q=a.slice(Math.max(r-3,0),
r);if(q&&g.test(q))continue}var q=r+a.slice(r).search(f),h=a.slice(r,q).replace(k,"");d.ignore&&d.ignore.test(h)||(q=r+h.length,h=c(h,r,q,a),a=a.slice(0,r)+h+a.slice(q),e.lastIndex=r+h.length)}e.lastIndex=0;return a};b.ensureValidHostname=function(a){if(a.match(b.invalid_hostname_characters)){if(!e)throw new TypeError('Hostname "'+a+'" contains characters other than [A-Z0-9.-] and Punycode.js is not available');if(e.toASCII(a).match(b.invalid_hostname_characters))throw new TypeError('Hostname "'+
a+'" contains characters other than [A-Z0-9.-]');}};b.noConflict=function(a){if(a)return a={URI:this.noConflict()},u.URITemplate&&"function"===typeof u.URITemplate.noConflict&&(a.URITemplate=u.URITemplate.noConflict()),u.IPv6&&"function"===typeof u.IPv6.noConflict&&(a.IPv6=u.IPv6.noConflict()),u.SecondLevelDomains&&"function"===typeof u.SecondLevelDomains.noConflict&&(a.SecondLevelDomains=u.SecondLevelDomains.noConflict()),a;u.URI===this&&(u.URI=p);return this};f.build=function(a){if(!0===a)this._deferred_build=
!0;else if(void 0===a||this._deferred_build)this._string=b.build(this._parts),this._deferred_build=!1;return this};f.clone=function(){return new b(this)};f.valueOf=f.toString=function(){return this.build(!1)._string};f.protocol=t("protocol");f.username=t("username");f.password=t("password");f.hostname=t("hostname");f.port=t("port");f.query=w("query","?");f.fragment=w("fragment","#");f.search=function(a,c){var b=this.query(a,c);return"string"===typeof b&&b.length?"?"+b:b};f.hash=function(a,c){var b=
...
a.path||a.pathname);a.nodeName&&(f=b.getDomAttribute(a),a=a[f]||"",f=!1);!e&&f&&void 0!==a.pathname&&(a=a.toString());if("string"===typeof a||a instanceof String)this._parts=b.parse(String(a),this._parts);else if(e||f)for(d in e=e?a._parts:a,e)B.call(this._parts,d)&&(this._parts[d]=e[d]);else throw new TypeError("invalid input");this.build(!c);return this};f.is=function(a){var c=!1,d=!1,e=!1,f=!1,k=!1,r=!1,q=!1,h=!this._parts.urn;this._parts.hostname&&(h=!1,d=b.ip4_expression.test(this._parts.hostname),
e=b.ip6_expression.test(this._parts.hostname),c=d||e,k=(f=!c)&&g&&g.has(this._parts.hostname),r=f&&b.idn_expression.test(this._parts.hostname),q=f&&b.punycode_expression.test(this._parts.hostname));switch(a.toLowerCase()){case "relative":return h;case "absolute":return!h;case "domain":case "name":return f;case "sld":return k;case "ip":return c;case "ip4":case "ipv4":case "inet4":return d;case "ip6":case "ipv6":case "inet6":return e;case "idn":return r;case "url":return!this._parts.urn;case "urn":return!!this._parts.urn;
...
b.ensureValidHostname(a);!this._parts.hostname||this.is("IP")?this._parts.hostname=a:(d=new RegExp(l(this.domain())+"$"),this._parts.hostname=this._parts.hostname.replace(d,a));this.build(!c);return this};f.tld=function(a,c){if(this._parts.urn)return void 0===a?"":this;"boolean"===typeof a&&(c=a,a=void 0);if(void 0===a){if(!this._parts.hostname||this.is("IP"))return"";var b=this._parts.hostname.lastIndexOf("."),b=this._parts.hostname.substring(b+1);return!0!==c&&g&&g.list[b.toLowerCase()]?g.get(this._parts.hostname)||
b:b}if(a)if(a.match(/[^a-zA-Z0-9-]/))if(g&&g.is(a))b=new RegExp(l(this.tld())+"$"),this._parts.hostname=this._parts.hostname.replace(b,a);else throw new TypeError('TLD "'+a+'" contains characters other than [A-Z0-9]');else{if(!this._parts.hostname||this.is("IP"))throw new ReferenceError("cannot set TLD on non-domain host");b=new RegExp(l(this.tld())+"$");this._parts.hostname=this._parts.hostname.replace(b,a)}else throw new TypeError("cannot set TLD empty");this.build(!c);return this};f.directory=
function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a||!0===a){if(!this._parts.path&&!this._parts.hostname)return"";if("/"===this._parts.path)return"/";var d=this._parts.path.length-this.filename().length-1,d=this._parts.path.substring(0,d)||(this._parts.hostname?"/":"");return a?b.decodePath(d):d}d=this._parts.path.length-this.filename().length;d=this._parts.path.substring(0,d);d=new RegExp("^"+l(d));this.is("relative")||(a||(a="/"),"/"!==a.charAt(0)&&(a="/"+a));a&&"/"!==a.charAt(a.length-
1)&&(a+="/");a=b.recodePath(a);this._parts.path=this._parts.path.replace(d,a);this.build(!c);return this};f.filename=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a||!0===a){if(!this._parts.path||"/"===this._parts.path)return"";var d=this._parts.path.lastIndexOf("/"),d=this._parts.path.substring(d+1);return a?b.decodePathSegment(d):d}d=!1;"/"===a.charAt(0)&&(a=a.substring(1));a.match(/\.?\//)&&(d=!0);var e=new RegExp(l(this.filename())+"$");a=b.recodePath(a);this._parts.path=
this._parts.path.replace(e,a);d?this.normalizePath(c):this.build(!c);return this};f.suffix=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0===a||!0===a){if(!this._parts.path||"/"===this._parts.path)return"";var d=this.filename(),e=d.lastIndexOf(".");if(-1===e)return"";d=d.substring(e+1);d=/^[a-z0-9%]+$/i.test(d)?d:"";return a?b.decodePathSegment(d):d}"."===a.charAt(0)&&(a=a.substring(1));if(d=this.suffix())e=a?new RegExp(l(d)+"$"):new RegExp(l("."+d)+"$");else{if(!a)return this;
this._parts.path+="."+b.recodePath(a)}e&&(a=b.recodePath(a),this._parts.path=this._parts.path.replace(e,a));this.build(!c);return this};f.segment=function(a,c,b){var e=this._parts.urn?":":"/",f=this.path(),k="/"===f.substring(0,1),f=f.split(e);void 0!==a&&"number"!==typeof a&&(b=c,c=a,a=void 0);if(void 0!==a&&"number"!==typeof a)throw Error('Bad segment "'+a+'", must be 0-based integer');k&&f.shift();0>a&&(a=Math.max(f.length+a,0));if(void 0===c)return void 0===a?f:f[a];if(null===a||void 0===f[a])if(n(c)){f=
[];a=0;for(var g=c.length;a<g;a++)if(c[a].length||f.length&&f[f.length-1].length)f.length&&!f[f.length-1].length&&f.pop(),f.push(c[a])}else{if(c||"string"===typeof c)""===f[f.length-1]?f[f.length-1]=c:f.push(c)}else c?f[a]=c:f.splice(a,1);k&&f.unshift("");return this.path(f.join(e),b)};f.segmentCoded=function(a,c,d){var f,e;"number"!==typeof a&&(d=c,c=a,a=void 0);if(void 0===c){a=this.segment(a,c,d);if(n(a))for(f=0,e=a.length;f<e;f++)a[f]=b.decode(a[f]);else a=void 0!==a?b.decode(a):void 0;return a}if(n(c))for(f=
0,e=c.length;f<e;f++)c[f]=b.decode(c[f]);else c="string"===typeof c||c instanceof String?b.encode(c):c;return this.segment(a,c,d)};var I=f.query;f.query=function(a,c){if(!0===a)return b.parseQuery(this._parts.query,this._parts.escapeQuerySpace);if("function"===typeof a){var d=b.parseQuery(this._parts.query,this._parts.escapeQuerySpace),f=a.call(this,d);this._parts.query=b.buildQuery(f||d,this._parts.duplicateQueryParameters,this._parts.escapeQuerySpace);this.build(!c);return this}return void 0!==
a&&"string"!==typeof a?(this._parts.query=b.buildQuery(a,this._parts.duplicateQueryParameters,this._parts.escapeQuerySpace),this.build(!c),this):I.call(this,a,c)};f.setQuery=function(a,c,d){var f=b.parseQuery(this._parts.query,this._parts.escapeQuerySpace);if("string"===typeof a||a instanceof String)f[a]=void 0!==c?c:null;else if("object"===typeof a)for(var e in a)B.call(a,e)&&(f[e]=a[e]);else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");this._parts.query=
...
this._parts.escapeQuerySpace)):this._parts.query=null,this.build(!a));return this};f.normalizeFragment=function(a){this._parts.fragment||(this._parts.fragment=null,this.build(!a));return this};f.normalizeSearch=f.normalizeQuery;f.normalizeHash=f.normalizeFragment;f.iso8859=function(){var a=b.encode,c=b.decode;b.encode=escape;b.decode=decodeURIComponent;try{this.normalize()}finally{b.encode=a,b.decode=c}return this};f.unicode=function(){var a=b.encode,c=b.decode;b.encode=q;b.decode=unescape;try{this.normalize()}finally{b.encode=
a,b.decode=c}return this};f.readable=function(){var a=this.clone();a.username("").password("").normalize();var c="";a._parts.protocol&&(c+=a._parts.protocol+"://");a._parts.hostname&&(a.is("punycode")&&e?(c+=e.toUnicode(a._parts.hostname),a._parts.port&&(c+=":"+a._parts.port)):c+=a.host());a._parts.hostname&&a._parts.path&&"/"!==a._parts.path.charAt(0)&&(c+="/");c+=a.path(!0);if(a._parts.query){for(var d="",f=0,k=a._parts.query.split("&"),g=k.length;f<g;f++){var r=(k[f]||"").split("="),d=d+("&"+b.decodeQuery(r[0],
...
for(f=0;e=d[f];f++)c._parts[e]=a._parts[e];c._parts.path?".."===c._parts.path.substring(-2)&&(c._parts.path+="/"):(c._parts.path=a._parts.path,c._parts.query||(c._parts.query=a._parts.query));"/"!==c.path().charAt(0)&&(d=(d=a.directory())?d:0===a.path().indexOf("/")?"/":"",c._parts.path=(d?d+"/":"")+c._parts.path,c.normalizePath());c.build();return c};f.relativeTo=function(a){var c=this.clone().normalize(),d,f,e,k;if(c._parts.urn)throw Error("URNs do not have any generally defined hierarchical components");
a=(new b(a)).normalize();d=c._parts;f=a._parts;e=c.path();k=a.path();if("/"!==e.charAt(0))throw Error("URI is already relative");if("/"!==k.charAt(0))throw Error("Cannot calculate a URI relative to another relative URI");d.protocol===f.protocol&&(d.protocol=null);if(d.username===f.username&&d.password===f.password&&null===d.protocol&&null===d.username&&null===d.password&&d.hostname===f.hostname&&d.port===f.port)d.hostname=null,d.port=null;else return c.build();if(e===k)return d.path="",c.build();
a=b.commonPath(c.path(),a.path());if(!a)return c.build();f=f.path.substring(a.length).replace(/[^\/]*$/,"").replace(/.*?\//g,"../");d.path=f+d.path.substring(a.length);return c.build()};f.equals=function(a){var c=this.clone();a=new b(a);var d={},f={},e={},k;c.normalize();a.normalize();if(c.toString()===a.toString())return!0;d=c.query();f=a.query();c.query("");a.query("");if(c.toString()!==a.toString()||d.length!==f.length)return!1;d=b.parseQuery(d,this._parts.escapeQuerySpace);f=b.parseQuery(f,this._parts.escapeQuerySpace);
for(k in d)if(B.call(d,k)){if(!n(d[k])){if(d[k]!==f[k])return!1}else if(!D(d[k],f[k]))return!1;e[k]=!0}for(k in f)if(B.call(f,k)&&!e[k])return!1;return!0};f.duplicateQueryParameters=function(a){this._parts.duplicateQueryParameters=!!a;return this};f.escapeQuerySpace=function(a){this._parts.escapeQuerySpace=!!a;return this};return b});
(function(e,h){"object"===typeof exports?module.exports=h(require("./URI")):"function"===typeof define&&define.amd?define(["./URI"],h):e.URITemplate=h(e.URI,e)})(this,function(e,h){function g(b){if(g._cache[b])return g._cache[b];if(!(this instanceof g))return new g(b);this.expression=b;g._cache[b]=this;return this}function u(b){this.data=b;this.cache={}}var b=h&&h.URITemplate,l=Object.prototype.hasOwnProperty,y=g.prototype,n={"":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encode"},
"+":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},"#":{prefix:"#",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},".":{prefix:".",separator:".",named:!1,empty_name_separator:!1,encode:"encode"},"/":{prefix:"/",separator:"/",named:!1,empty_name_separator:!1,encode:"encode"},";":{prefix:";",separator:";",named:!0,empty_name_separator:!1,encode:"encode"},"?":{prefix:"?",separator:"&",named:!0,empty_name_separator:!0,encode:"encode"},"&":{prefix:"&",
separator:"&",named:!0,empty_name_separator:!0,encode:"encode"}};g._cache={};g.EXPRESSION_PATTERN=/\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g;g.VARIABLE_PATTERN=/^([^*:]+)((\*)|:(\d+))?$/;g.VARIABLE_NAME_PATTERN=/[^a-zA-Z0-9%_]/;g.expand=function(b,e){var h=n[b.operator],k=h.named?"Named":"Unnamed",q=b.variables,t=[],w,p,f;for(f=0;p=q[f];f++)w=e.get(p.name),w.val.length?t.push(g["expand"+k](w,h,p.explode,p.explode&&h.separator||",",p.maxlength,p.name)):w.type&&t.push("");return t.length?h.prefix+t.join(h.separator):
""};g.expandNamed=function(b,g,h,k,q,t){var w="",p=g.encode;g=g.empty_name_separator;var f=!b[p].length,l=2===b.type?"":e[p](t),v,n,u;n=0;for(u=b.val.length;n<u;n++)q?(v=e[p](b.val[n][1].substring(0,q)),2===b.type&&(l=e[p](b.val[n][0].substring(0,q)))):f?(v=e[p](b.val[n][1]),2===b.type?(l=e[p](b.val[n][0]),b[p].push([l,v])):b[p].push([void 0,v])):(v=b[p][n][1],2===b.type&&(l=b[p][n][0])),w&&(w+=k),h?w+=l+(g||v?"=":"")+v:(n||(w+=e[p](t)+(g||v?"=":"")),2===b.type&&(w+=l+","),w+=v);return w};g.expandUnnamed=
function(b,g,h,k,q){var t="",w=g.encode;g=g.empty_name_separator;var p=!b[w].length,f,l,n,u;n=0;for(u=b.val.length;n<u;n++)q?l=e[w](b.val[n][1].substring(0,q)):p?(l=e[w](b.val[n][1]),b[w].push([2===b.type?e[w](b.val[n][0]):void 0,l])):l=b[w][n][1],t&&(t+=k),2===b.type&&(f=q?e[w](b.val[n][0].substring(0,q)):b[w][n][0],t+=f,t=h?t+(g||l?"=":""):t+","),t+=l;return t};g.noConflict=function(){h.URITemplate===g&&(h.URITemplate=b);return g};y.expand=function(b){var e="";this.parts&&this.parts.length||this.parse();
b instanceof u||(b=new u(b));for(var h=0,k=this.parts.length;h<k;h++)e+="string"===typeof this.parts[h]?this.parts[h]:g.expand(this.parts[h],b);return e};y.parse=function(){var b=this.expression,e=g.EXPRESSION_PATTERN,h=g.VARIABLE_PATTERN,k=g.VARIABLE_NAME_PATTERN,q=[],t=0,l,p,f;for(e.lastIndex=0;;){p=e.exec(b);if(null===p){q.push(b.substring(t));break}else q.push(b.substring(t,p.index)),t=p.index+p[0].length;if(!n[p[1]])throw Error('Unknown Operator "'+p[1]+'" in "'+p[0]+'"');if(!p[3])throw Error('Unclosed Expression "'+
p[0]+'"');l=p[2].split(",");for(var u=0,v=l.length;u<v;u++){f=l[u].match(h);if(null===f)throw Error('Invalid Variable "'+l[u]+'" in "'+p[0]+'"');if(f[1].match(k))throw Error('Invalid Variable Name "'+f[1]+'" in "'+p[0]+'"');l[u]={name:f[1],explode:!!f[3],maxlength:f[4]&&parseInt(f[4],10)}}if(!l.length)throw Error('Expression Missing Variable(s) "'+p[0]+'"');q.push({expression:p[0],operator:p[1],variables:l})}q.length||q.push(b);this.parts=q;return this};u.prototype.get=function(b){var e=this.data,
...
(function(e,h){"object"===typeof exports?module.exports=h(require("jquery","./URI")):"function"===typeof define&&define.amd?define(["jquery","./URI"],h):h(e.jQuery,e.URI)})(this,function(e,h){function g(b){return b.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")}function u(b){var e=b.nodeName.toLowerCase();return"input"===e&&"image"!==b.type?void 0:h.domAttributes[e]}function b(b){return{get:function(g){return e(g).uri()[b]()},set:function(g,h){e(g).uri()[b](h);return h}}}function l(b,g){var h,l,p;if(!u(b)||
!g)return!1;h=g.match(D);if(!h||!h[5]&&":"!==h[2]&&!n[h[2]])return!1;p=e(b).uri();if(h[5])return p.is(h[5]);if(":"===h[2])return l=h[1].toLowerCase()+":",n[l]?n[l](p,h[4]):!1;l=h[1].toLowerCase();return y[l]?n[h[2]](p[l](),h[4],l):!1}var y={},n={"=":function(b,e){return b===e},"^=":function(b,e){return!!(b+"").match(new RegExp("^"+g(e),"i"))},"$=":function(b,e){return!!(b+"").match(new RegExp(g(e)+"$","i"))},"*=":function(b,e,h){"directory"===h&&(b+="/");return!!(b+"").match(new RegExp(g(e),"i"))},
"equals:":function(b,e){return b.equals(e)},"is:":function(b,e){return b.is(e)}};e.each("authority directory domain filename fragment hash host hostname href password path pathname port protocol query resource scheme search subdomain suffix tld username".split(" "),function(g,h){y[h]=!0;e.attrHooks["uri:"+h]=b(h)});var r=function(b,g){return e(b).uri().href(g).toString()};e.each(["src","href","action","uri","cite"],function(b,g){e.attrHooks[g]={set:r}});e.attrHooks.uri.get=function(b){return e(b).uri()};
e.fn.uri=function(b){var e=this.first(),g=e.get(0),l=u(g);if(!l)throw Error('Element "'+g.nodeName+'" does not have either property: href, src, action, cite');if(void 0!==b){var n=e.data("uri");if(n)return n.href(b);b instanceof h||(b=h(b||""))}else{if(b=e.data("uri"))return b;b=h(e.attr(l)||"")}b._dom_element=g;b._dom_attribute=l;b.normalize();e.data("uri",b);return b};h.prototype.build=function(b){if(this._dom_element)this._string=h.build(this._parts),this._deferred_build=!1,this._dom_element.setAttribute(this._dom_attribute,
this._string),this._dom_element[this._dom_attribute]=this._string;else if(!0===b)this._deferred_build=!0;else if(void 0===b||this._deferred_build)this._string=h.build(this._parts),this._deferred_build=!1;return this};var z,D=/^([a-zA-Z]+)\s*([\^\$*]?=|:)\s*(['"]?)(.+)\3|^\s*([a-zA-Z0-9]+)\s*$/;z=e.expr.createPseudo?e.expr.createPseudo(function(b){return function(e){return l(e,b)}}):function(b,e,g){return l(b,g[3])};e.expr[":"].uri=z;return e});
/*
